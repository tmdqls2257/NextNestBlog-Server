...
exports.test1663434148444 = void 0;
class test1663434148444 {
    constructor() {
        this.name = 'test1663434148444';
    }
    async up(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "USER_PROFILE" DROP COLUMN "deleted_at"`);
        ...
        await queryRunner.query(`ALTER TABLE "USER_PROFILE" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "USER_PROFILE" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "USER_PROFILE" ADD "deletedAt" TIMESTAMP WITH TIME ZONE`);
        ...
        await queryRunner.query(`ALTER TABLE "VISITOR" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "VISITOR" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "VISITOR" ADD "deletedAt" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "BLOG" ADD "createdAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "BLOG" ADD "updatedAt" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "BLOG" ADD "deletedAt" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "BLOG" ADD "likeCount" integer DEFAULT '0'`);
    }
    async down(queryRunner) {
        ...
        await queryRunner.query(`ALTER TABLE "USER_PROFILE" DROP COLUMN "deletedAt"`);
        ...
        await queryRunner.query(`ALTER TABLE "BLOG" ADD "like_count" integer DEFAULT '0'`);
        await queryRunner.query(`ALTER TABLE "BLOG" ADD "deleted_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "BLOG" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "BLOG" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "VISITOR" ADD "deleted_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "VISITOR" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "VISITOR" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "TAG" ADD "deleted_at" TIMESTAMP WITH TIME ZONE`);
        await queryRunner.query(`ALTER TABLE "TAG" ADD "updated_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        await queryRunner.query(`ALTER TABLE "TAG" ADD "created_at" TIMESTAMP WITH TIME ZONE NOT NULL DEFAULT now()`);
        ...
        await queryRunner.query(`ALTER TABLE "USER_PROFILE" ADD "deleted_at" TIMESTAMP WITH TIME ZONE`);
...
exports.test1663434148444 = test1663434148444;
//# sourceMappingURL=1663434148444-test.js.map